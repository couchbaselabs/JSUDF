...
var insertquery = INSERT INTO emp VALUES (uuid(),{"emp_name":"BBB","emp_no":"1000","salary":"25000","manager":"AAA"});
var insertquery = INSERT INTO emp VALUES (uuid(),{"emp_name":"XXX","emp_no":"1001","salary":"10000","manager":"BBB"});
var insertquery = INSERT INTO emp VALUES (uuid(),{"emp_name":"YYY","emp_no":"1002","salary":"10000","manager":"BBB"});
var insertquery = INSERT INTO emp VALUES (uuid(),{"emp_name":"ZZZ","emp_no":"1003","salary":"7500","manager":"BBB"});
var query = COMMIT WORK;

var querybegin=BEGIN WORK;
var updatequery = UPDATE emp SET salary=15000 WHERE emp_name='XXX';
var query = COMMIT WORK;

var querybegin=BEGIN WORK;
var updatequery = DELETE from emp WHERE emp_name='ZZZ';
var query = COMMIT WORK;

var selectquery =SELECT emp_name,emp_no,salary,manager FROM emp WHERE emp_name='XXX';
var rs = [];
